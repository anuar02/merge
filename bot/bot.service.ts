...
export class BotService {
    ...
    getSessions(botId: string, params?: any): Observable<ServerResponse<Session>> {
        return this.http.get<ServerResponse<Session>>(`resources/bot/${botId}/session`, { params });
    }

    createSession(botId: string): Observable<Session> {
        return this.http.post<Session>(`resources/bot/${botId}/session/create`, {});
    }

    getBotDetails(botId: string): Observable<Bot> {
        return this.http.get<Bot>(`resources/bot/${botId}`);
    }
    ...
    grabGroups(botId: string, payload?: GrabGroupPayload) {
        return this.http.post(`resources/bot/${botId}/grabGroups`, payload);
    }
