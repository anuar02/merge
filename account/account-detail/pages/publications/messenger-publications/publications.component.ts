...
@Component({
    selector: 'app-messenger-publications',
    imports: [NgIf, NgFor, CommonModule, SearchBarComponent, MediaViewComponent, NotFoundComponent, TranslocoPipe],
    templateUrl: './publications.component.html',
    styleUrl: './publications.component.scss',
    standalone: true
})
export class MessengerPublicationsComponent implements OnDestroy, AfterViewInit {
