...
export class DeanonApiService {
    ...
    getExampleFile(method: Method): Observable<any> {
        return this.http.get(`resources/account-deanon/example?method=${method}`, { responseType: 'blob' });
    }
    ...
    getPingVpnTasks(accountId: string, params?: any): Observable<any> {
        return this.http.get(`resources/account-deanon/${accountId}/ping_vpn/tasks`, { params });
    }

    getPingVpnTasksCount(accountId: string): Observable<any> {
        return this.http.get(`resources/account-deanon/${accountId}/ping_vpn/tasks/count`);
    }
    ...
    getAccountDeanonInfo(accountId: string, method: Method): Observable<AccountDeanonInfo> {
        return this.http.get<AccountDeanonInfo>(`resources/account-deanon/${accountId}?method=${method}`);
    }
    ...
    getPhotos(accountId: string, params?: any): Observable<ServerResponse<Photo>> {
        return this.http.post<ServerResponse<Photo>>(`resources/account-deanon/photos/${accountId}`, {}, { params });
    }

    filterIdentifiedFaces(accountId: string, payload: CropsPayload,  params?: any): Observable<ServerResponse<IdentifiedFace>> {
        return this.http.post<ServerResponse<IdentifiedFace>>(`resources/account-deanon/crops/${accountId}`, payload, { params });
    }
    ...
    getPhotosSentToDeanon(accountId: string, params?: any): Observable<ServerResponse<PhotoSentToDeanon>> {
        return this.http.get<ServerResponse<PhotoSentToDeanon>>(`resources/account-deanon/crops/params/${accountId}`, { params });
    }

    downloadActivities(accountId: string): Observable<HttpResponse<Blob>>  {
        return this.http.get(`resources/account-deanon/download/activities/${accountId}`, {
            observe: 'response',
            responseType: 'blob',
            params: {
                timezoneOffset: -(new Date().getTimezoneOffset() / 60),
    ...
    downloadPingVpn(accountId: string, taskId: string): Observable<HttpResponse<Blob>>  {
        return this.http.get(`resources/account-deanon/download/ping_vpn/${accountId}/${taskId}`, {
            observe: 'response',
            responseType: 'blob',
            params: {
                timezoneOffset: -(new Date().getTimezoneOffset() / 60),
